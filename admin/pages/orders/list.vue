<template>
                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class="col-lg-8 col-md-8 col-sm-12 mb-2">
                                    <input type="text" v-model="searchQuery" class="form-control" placeholder="Order ID" />
                                </div>
  ...
  <option v-for="(status, index) in orderStatus" :key="index" :value="status.id">{{ status.name }}</option>
</select>
